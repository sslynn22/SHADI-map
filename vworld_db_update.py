...
MINX, MINY, MAXX, MAXY = 127.344526, 36.360043, 127.350182, 36.360306

# 분석 타임스탬프(모든 테이블 이름 재사용) — 기본값 예: 20240731_1800
# 'YYYYMMDD_HHMM' 또는 'YYYYMMDD'(날짜만 → 08~19시 일괄# vworld_db_update.py
import os, re, math, hashlib, requests, datetime, warnings
import geopandas as gpd
from shapely.geometry import Polygon, MultiPolygon, GeometryCollection, Point
from shapely import affinity, wkb
...
# 예시 BBOX (원하는 범위로 바꾸세요)
MINX, MINY, MAXX, MAXY = 127.336120, 36.361275, 127.343720, 36.364119
...
def _stamps_for_date(date_str: str, start_h=9, end_h=15):
    """'YYYYMMDD' → ['YYYYMMDD_0900', ..., 'YYYYMMDD_1500']"""
